...
import { registerUser } from '../api/loginPanel'
import { toast } from 'sonner'
import type { AuthPanelRegister } from '../schemas/authPanel'

export const RegisterView = () => {
    const initialValues: AuthPanelRegister = {
        email: "",
        password: "",
    ...
    const handleLogin = (formData: AuthPanelRegister) => mutate(formData)
